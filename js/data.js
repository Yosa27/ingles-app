...
const VOCAB = [
  ...
  // ===== NÚMEROS Y CANTIDADES (nivel 1) =====
  { id:"n01", en:"one", es:"uno", ej:"I have one brother.", ex:"Tengo un hermano.", niv:1, cat:"numeros" },
  { id:"n02", en:"two", es:"dos", ej:"There are two cups on the table.", ex:"Hay dos tazas sobre la mesa.", niv:1, cat:"numeros" },
  { id:"n03", en:"three", es:"tres", ej:"She has three cats.", ex:"Ella tiene tres gatos.", niv:1, cat:"numeros" },
  { id:"n04", en:"four", es:"cuatro", ej:"The meeting ends at four.", ex:"La reunión termina a las cuatro.", niv:1, cat:"numeros" },
  { id:"n05", en:"five", es:"cinco", ej:"I need five minutes.", ex:"Necesito cinco minutos.", niv:1, cat:"numeros" },
  { id:"n06", en:"six", es:"seis", ej:"It costs six dollars.", ex:"Cuesta seis dólares.", niv:1, cat:"numeros" },
  { id:"n07", en:"seven", es:"siete", ej:"There are seven days in a week.", ex:"Hay siete días en una semana.", niv:1, cat:"numeros" },
  { id:"n08", en:"eight", es:"ocho", ej:"I wake up at eight.", ex:"Me despierto a las ocho.", niv:1, cat:"numeros" },
  { id:"n09", en:"nine", es:"nueve", ej:"The bus arrives at nine.", ex:"El bus llega a las nueve.", niv:1, cat:"numeros" },
  { id:"n10", en:"ten", es:"diez", ej:"I slept ten hours.", ex:"Dormí diez horas.", niv:1, cat:"numeros" },
  { id:"n11", en:"twenty", es:"veinte", ej:"The ticket costs twenty dollars.", ex:"El boleto cuesta veinte dólares.", niv:1, cat:"numeros" },
  { id:"n12", en:"hundred", es:"cien / ciento", ej:"That's a hundred pesos.", ex:"Eso son cien pesos.", niv:1, cat:"numeros" },
  { id:"n13", en:"thousand", es:"mil", ej:"The price is two thousand.", ex:"El precio es dos mil.", niv:1, cat:"numeros" },
  { id:"n14", en:"half", es:"mitad / medio", ej:"I drank half a glass.", ex:"Bebí medio vaso.", niv:1, cat:"numeros" },
  { id:"n15", en:"dozen", es:"docena", ej:"A dozen eggs, please.", ex:"Una docena de huevos, por favor.", niv:1, cat:"numeros" },
  { id:"n16", en:"a little", es:"un poco", ej:"I speak a little English.", ex:"Hablo un poco de inglés.", niv:1, cat:"numeros" },
  { id:"n17", en:"a lot", es:"mucho / en cantidad", ej:"She has a lot of friends.", ex:"Ella tiene muchos amigos.", niv:1, cat:"numeros" },
  { id:"n18", en:"few", es:"pocos / pocas", ej:"There are few people here.", ex:"Hay pocas personas aquí.", niv:1, cat:"numeros" },
  { id:"n19", en:"enough", es:"suficiente / bastantes", ej:"We have enough time.", ex:"Tenemos suficiente tiempo.", niv:1, cat:"numeros" },
  { id:"n20", en:"both", es:"ambos / las dos", ej:"Both options are good.", ex:"Ambas opciones son buenas.", niv:1, cat:"numeros" },
  { id:"n21", en:"each", es:"cada / cada uno", ej:"Each ticket costs five dollars.", ex:"Cada boleto cuesta cinco dólares.", niv:1, cat:"numeros" },
  { id:"n22", en:"how much", es:"cuánto (cantidad/monto)", ej:"How much does it cost?", ex:"¿Cuánto cuesta?", niv:1, cat:"numeros" },
  { id:"n23", en:"how many", es:"cuántos / cuántas", ej:"How many apples do you want?", ex:"¿Cuántas manzanas quieres?", niv:1, cat:"numeros" },
  { id:"n24", en:"more", es:"más", ej:"I need more sugar.", ex:"Necesito más azúcar.", niv:1, cat:"numeros" },
  { id:"n25", en:"less", es:"menos", ej:"Drink less coffee.", ex:"Bebe menos café.", niv:1, cat:"numeros" },

  // ===== HORAS Y TIEMPO (nivel 1-2) =====
  { id:"h01", en:"hour", es:"hora", ej:"The trip takes one hour.", ex:"El viaje toma una hora.", niv:1, cat:"tiempo" },
  { id:"h02", en:"minute", es:"minuto", ej:"Wait a minute, please.", ex:"Espera un minuto, por favor.", niv:1, cat:"tiempo" },
  { id:"h03", en:"second", es:"segundo", ej:"Give me a second.", ex:"Dame un segundo.", niv:1, cat:"tiempo" },
  { id:"h04", en:"o'clock", es:"en punto", ej:"The show starts at nine o'clock.", ex:"El show empieza a las nueve en punto.", niv:1, cat:"tiempo" },
  { id:"h05", en:"half past", es:"y media", ej:"It's half past three.", ex:"Son las tres y media.", niv:1, cat:"tiempo" },
  { id:"h06", en:"quarter past", es:"y cuarto", ej:"It's a quarter past ten.", ex:"Son las diez y cuarto.", niv:1, cat:"tiempo" },
  { id:"h07", en:"quarter to", es:"menos cuarto", ej:"It's a quarter to five.", ex:"Son las cinco menos cuarto.", niv:1, cat:"tiempo" },
  { id:"h08", en:"am", es:"antes del mediodía (AM)", ej:"I wake up at 6 am.", ex:"Me despierto a las 6 de la mañana.", niv:1, cat:"tiempo" },
  { id:"h09", en:"pm", es:"después del mediodía (PM)", ej:"I finish work at 5 pm.", ex:"Termino el trabajo a las 5 de la tarde.", niv:1, cat:"tiempo" },
  { id:"h10", en:"noon", es:"mediodía", ej:"Let's eat at noon.", ex:"Comamos al mediodía.", niv:1, cat:"tiempo" },
  { id:"h11", en:"midnight", es:"medianoche", ej:"The party ended at midnight.", ex:"La fiesta terminó a la medianoche.", niv:1, cat:"tiempo" },
  { id:"h12", en:"weekend", es:"fin de semana", ej:"We relax on the weekend.", ex:"Descansamos el fin de semana.", niv:1, cat:"tiempo" },
  { id:"h13", en:"weekday", es:"día entre semana", ej:"I wake up early on weekdays.", ex:"Me despierto temprano entre semana.", niv:1, cat:"tiempo" },
  { id:"h14", en:"year", es:"año", ej:"Next year I'll study more.", ex:"El próximo año estudiaré más.", niv:1, cat:"tiempo" },
  { id:"h15", en:"date", es:"fecha", ej:"What's the date today?", ex:"¿Cuál es la fecha de hoy?", niv:2, cat:"tiempo" },
  { id:"h16", en:"Monday", es:"lunes", ej:"I have class on Monday.", ex:"Tengo clase el lunes.", niv:1, cat:"tiempo" },
  { id:"h17", en:"Tuesday", es:"martes", ej:"See you on Tuesday.", ex:"Nos vemos el martes.", niv:1, cat:"tiempo" },
  { id:"h18", en:"Wednesday", es:"miércoles", ej:"The meeting is on Wednesday.", ex:"La reunión es el miércoles.", niv:1, cat:"tiempo" },
  { id:"h19", en:"Thursday", es:"jueves", ej:"I run on Thursday.", ex:"Corro los jueves.", niv:1, cat:"tiempo" },
  { id:"h20", en:"Friday", es:"viernes", ej:"Friday is my favorite day.", ex:"El viernes es mi día favorito.", niv:1, cat:"tiempo" },
  { id:"h21", en:"Saturday", es:"sábado", ej:"We go out on Saturday.", ex:"Salimos el sábado.", niv:1, cat:"tiempo" },
  { id:"h22", en:"Sunday", es:"domingo", ej:"I rest on Sunday.", ex:"Descanso el domingo.", niv:1, cat:"tiempo" },
  { id:"h23", en:"January", es:"enero", ej:"My birthday is in January.", ex:"Mi cumpleaños es en enero.", niv:1, cat:"tiempo" },
  { id:"h24", en:"February", es:"febrero", ej:"February has 28 days.", ex:"Febrero tiene 28 días.", niv:1, cat:"tiempo" },
  { id:"h25", en:"March", es:"marzo", ej:"Spring starts in March.", ex:"La primavera empieza en marzo.", niv:1, cat:"tiempo" },
  { id:"h26", en:"April", es:"abril", ej:"April is rainy here.", ex:"Abril es lluvioso aquí.", niv:1, cat:"tiempo" },
  { id:"h27", en:"May", es:"mayo", ej:"We travel in May.", ex:"Viajamos en mayo.", niv:1, cat:"tiempo" },
  { id:"h28", en:"June", es:"junio", ej:"June is warm.", ex:"Junio es cálido.", niv:1, cat:"tiempo" },
  { id:"h29", en:"July", es:"julio", ej:"Let's meet in July.", ex:"Encontrémonos en julio.", niv:1, cat:"tiempo" },
  { id:"h30", en:"August", es:"agosto", ej:"August is vacation time.", ex:"Agosto es época de vacaciones.", niv:1, cat:"tiempo" },
  { id:"h31", en:"September", es:"septiembre", ej:"School starts in September.", ex:"La escuela empieza en septiembre.", niv:1, cat:"tiempo" },
  { id:"h32", en:"October", es:"octubre", ej:"October is my favorite month.", ex:"Octubre es mi mes favorito.", niv:1, cat:"tiempo" },
  { id:"h33", en:"November", es:"noviembre", ej:"It gets cold in November.", ex:"Hace frío en noviembre.", niv:1, cat:"tiempo" },
  { id:"h34", en:"December", es:"diciembre", ej:"We celebrate in December.", ex:"Celebramos en diciembre.", niv:1, cat:"tiempo" },
  { id:"h35", en:"season", es:"estación (del año)", ej:"What's your favorite season?", ex:"¿Cuál es tu estación favorita?", niv:2, cat:"tiempo" },
  { id:"h36", en:"spring", es:"primavera", ej:"The flowers bloom in spring.", ex:"Las flores florecen en primavera.", niv:1, cat:"tiempo" },
  { id:"h37", en:"summer", es:"verano", ej:"I love summer.", ex:"Amo el verano.", niv:1, cat:"tiempo" },
  { id:"h38", en:"autumn", es:"otoño", ej:"Autumn leaves are beautiful.", ex:"Las hojas de otoño son hermosas.", niv:1, cat:"tiempo" },
  { id:"h39", en:"winter", es:"invierno", ej:"Winter is very cold.", ex:"El invierno es muy frío.", niv:1, cat:"tiempo" },
];
...
const CATEGORIAS = [
  ...
  { clave:"numeros", nombre:"Números y cantidades" },
  { clave:"tiempo", nombre:"Horas y tiempo" }
];
